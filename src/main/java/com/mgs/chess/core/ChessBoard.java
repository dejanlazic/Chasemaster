...
public class ChessBoard {
  ...
  public PieceOnLocation getPieceOnLocation(String location) {
    return new PieceOnLocation(getSquareContent(Location.forString(location)).asPiece(), Location.forString(location));
  }
